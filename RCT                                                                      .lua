...
game:GetService("StarterGui"):SetCore("SendNotification",
    {
        Title = "R(oblox)C(hat)T(ranslate)",
        Text = "Thanks for using RCT. The pastebin link to see the translate cods has been coppied to your clipboard.",
        setclipboard ("https://pastebin.com/raw/Y312VK60"),
        Duration = 5
    }
)
                  
properties.Text = "[RCT ~ by Gabe]  pastebin link to Key letters/Words has been copied to clipboard. If you have script in autoexecute and join murder mystery 2 take out of auto execute and rejoin this will make the chat break (Wont be able to chat at all.)."
...
function disableSend()
    sendEnabled = false
    properties.Text = "[RCT]  Sending Disabled"
    StarterGui:SetCore("ChatMakeSystemMessage", properties)
end
